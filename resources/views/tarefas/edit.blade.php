        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="titulo" class="form-control" placeholder="Titulo" value="{{$tarefa->titulo}}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="descricao" class="form-control" 
                        placeholder="Descricao" value="{{$tarefa->descricao}}" />
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <select name="status" class="form-control" 
                        ...
                        <option value="feita" @if($tarefa->status=='feita') {{"selected"}} @endif>Feita</option>    
                    </select>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
